...
- **AI Summary** - Search can answer your query with a short, cited summary of the top results, generated by your team's model provider
- **Integrations** - Setup pages in the app for the MCP server, the VibeXP CLI, the REST API (OpenAPI schema), and the Go and TypeScript API clients
